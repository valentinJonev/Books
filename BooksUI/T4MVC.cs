...
{
    public static BooksUI.Controllers.AuthorsController Authors = new BooksUI.Controllers.T4MVC_AuthorsController();
    public static BooksUI.Controllers.BooksController Books = new BooksUI.Controllers.T4MVC_BooksController();
    public static BooksUI.Controllers.HomeController Home = new BooksUI.Controllers.T4MVC_HomeController();
    public static BooksUI.Controllers.UserController User = new BooksUI.Controllers.T4MVC_UserController();
