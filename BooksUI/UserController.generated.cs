...
namespace BooksUI.Controllers
{
    public partial class UserController
    {
        ...
        public class ActionParamsClass_Register
        {
            public readonly string Username = "Username";
            public readonly string Password = "Password";
            public readonly string RepeatPassword = "RepeatPassword";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_UserController : BooksUI.Controllers.UserController
    {
        ...
        [NonAction]
        partial void RegisterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string Username, string Password, string RepeatPassword, int Age);

        [NonAction]
        public override System.Web.Mvc.ActionResult Register(string Username, string Password, string RepeatPassword, int Age)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "Username", Username);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "Password", Password);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "RepeatPassword", RepeatPassword);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "Age", Age);
            RegisterOverride(callInfo, Username, Password, RepeatPassword, Age);
            return callInfo;
        }
